/**
 * org.kyotogtug.hackathon090905.gamet.kaodroid.fw
 * KaodroidGameActivity.java
 *
 * @version 1.0
 * @author KATOU
 */
package org.kyotogtug.hackathon090905.gamet.kaodroid.fw;
...
public class KaodroidGameUtil {
	 ...
	 * @return グループデータ
	 */
	public Group roadGroup(Activity inActivity, Bundle inBundle) {
		...
		if (mCursor.moveToNext()) {
			...
			group.setImages(roadImages(inActivity, inBundle));
		}
	 ...
	 * @return　読み込んだ画像リスト
	 */
	protected List<Image> roadImages(Activity inActivity, Bundle inBundle) {
