...
class MainHandler(RequestHandler):
    ...
    def get(self):
        ...
        if not client.get_cookie():
            write('<a href="/twitter/oauth/twitter/login">Login via Twitter</a>')
            write(FOOTER)
            return

        write('<a href="/twitter/oauth/twitter/logout">Logout from Twitter</a><br /><br />')
