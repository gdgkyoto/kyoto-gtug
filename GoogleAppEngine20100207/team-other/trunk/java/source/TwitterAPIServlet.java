...
public class TwitterAPIServlet extends HttpServlet {
	public void doGet(HttpServletRequest req, HttpServletResponse resp)
	    ...
	    //MyTwitterテスト
	    if(MyTwitter.basicAuth("tngt000", "oth10fri"))
	    	out.println(MyTwitter.getListTimeLine("ts0604", "team-other", 2));

	    //リスト表示
//		TwitList twitList = new TwitList("ts0604", "team-other");	//リスト生成
