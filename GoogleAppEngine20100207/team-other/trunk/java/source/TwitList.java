...
class TwitList {
	...
	private String targetListFullName = "";	//取得対象リスト名
	...
	private static final String FAILURE_GET_LIST_TIMELINE = "リストのタイムラインの取得に失敗しました";
	...
	public TwitList(String targetID, String targetListName)
	{
		...
		try {
			...
			{
				if((list = this.findTargetList(this.targetListFullName, lists)) != null)	//対象のリストを探索;
				{
